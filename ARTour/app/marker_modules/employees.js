...
export function render(data) {
    ...
    var mid = -(data.response.data.length - (data.response.data.length/2));
        ...
        res += `
            ...
            >
                <a-text
                    ...
                    value="${el.name}"
                    width="1.5"
                    font="${config.font_directory}${data.response.config.font}/${data.response.config.font}_Black.fnt"
